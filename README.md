# SKN13-1st-5TEAM 
초록색 번호판 시행 이후 정책 실효성을 파악하기 위해 프로젝트를 시작했다. 
특히 슈퍼카 브랜드 판매량과 등록 변화를 살펴보고 사람들 인식을 조사한다. 
...
람보르기니, 맥라렌 등 슈퍼카 브랜드 차량의 약 80% 이상이 법인차로 등록되어 있고, 포르쉐, 롤스로이스 등도 마찬가지.
고가 차량을 법인 명의로 구매하면 부가세 환급, 유지비 비용처리, 법인세 절감 등의 혜택을 받을 수 있어 개인이 사적으로 이용하는 경우가 많아졌다.

📘 프로젝트 소개
이 프로젝트는 2024년 1월 1일부터 시행된 연두색 번호판 정책을 중심으로, 법인 슈퍼카 문제를 데이터 기반으로 분석한다. 
...
**📉 전년도(2023년)**까지만 해도 억대 수입차 시장은 호황이었다.
